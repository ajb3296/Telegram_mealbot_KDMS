...
def get_message(bot, update) :
    ...
    if update.message.text[0:2]=="어제":
        ...
        if meal==" ":
            ...
            meal1=meal
        update.message.reply_text("%s년 %s월 %s일 기준\n어제 급식(%s) :\n\n%s" %(now.year, now.month, now.day, yester.strftime('%Y년 %m월 %d일'), meal1), reply_markup=reply_markup)
    ...
    if update.message.text[0:2]=="오늘":
        ...
        if meal==" ":
            ...
            meal1=meal
        update.message.reply_text("%s년 %s월 %s일 기준\n오늘 급식 :\n\n%s"%(now.year, now.month, now.day, meal1), reply_markup=reply_markup)
    ...
    if update.message.text[0:2]=="내일":
        ...
        if meal==" ":
            ...
            meal1=meal
        update.message.reply_text("%s년 %s월 %s일 기준\n내일 급식(%s) :\n\n%s"%(now.year, now.month, now.day, tomorrow.strftime('%Y년 %m월 %d일'), meal1), reply_markup=reply_markup)
    ...
    if update.message.text[0:3]=="이틀뒤":
        ...
        if meal==" ":
            ...
            meal1=meal
        update.message.reply_text("%s년 %s월 %s일 기준\n이틀뒤 급식(%s) :\n\n%s"%(now.year,now.month, now.day, two.strftime('%Y년 %m월 %d일'), meal1), reply_markup=reply_markup)
    ...
    if update.message.text[0:3]=="3일뒤":
        ...
        if meal==" ":
            ...
            meal1=meal
        update.message.reply_text("%s년 %s월 %s일 기준\n3일뒤 급식(%s) :\n\n%s"%(now.year,now.month, now.day, three.strftime('%Y년 %m월 %d일'), meal1), reply_markup=reply_markup)
    ...
    if update.message.text[0:3]=="4일뒤":
        ...
        if meal==" ":
            ...
            meal1=meal
        update.message.reply_text("%s년 %s월 %s일 기준\n4일뒤 급식(%s) :\n\n%s"%(now.year,now.month, now.day, four.strftime('%Y년 %m월 %d일'), meal1), reply_markup=reply_markup)
